...
The tutorials use [Qiskit](https://www.ibm.com/quantum/qiskit) and Qiskit Aer for quantum circuits and simulation, [SympleQ](https://github.com/QuAOS-Lab/SympleQ) for stabilizer/symplectic circuit tools, [Quimb](https://quimb.readthedocs.io/) for tensor networks, and NumPy, SciPy, Matplotlib, and IPython kernel support.
